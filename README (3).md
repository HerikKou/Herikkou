...
<td>Microsserviços · Observabilidade · Cloud AWS · Testes automatizados</td>
</tr>
<tr>
<td><b>🛠️ Stack principal</b></td>
<td>Java 17+ · Spring Boot · Kafka · Docker · Datadog</td>
</tr>
<tr>
...
<div align="center">
  <img
    src="https://github-readme-activity-graph.vercel.app/graph?username=Herikkou&theme=github-compact&bg_color=0D1117&color=6DB33F&line=2E75B6&point=6DB33F&hide_border=true"
    width="100%"
  />
</div>
...
- Desenvolvimento de funcionalidades com **controle de acesso, perfis e permissões**
- Criação de **testes automatizados** e validação de funcionalidades
- Elaboração de **documentação técnica** dos sistemas
- Colaboração em equipe com **divisão de responsabilidades** e resolução de problemas

### 📚 Aprendizado Contínuo

Datadog · AWS · Kubernetes · Arquitetura de Sistemas Distribuídos
